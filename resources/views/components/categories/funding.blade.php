@props(['data'])
<section>
    <h2 id="funding-heading" class="text-2xl font-bold text-slate-900 dark:text-white mb-6">{{ __('admin.resources.funding.plural') }}</h2>
    <ul class="space-y-6">
        @foreach($data as $funding)
            <li>
                <article class="bg-white dark:bg-slate-800 p-5 rounded-lg border border-slate-200 dark:border-slate-700">
