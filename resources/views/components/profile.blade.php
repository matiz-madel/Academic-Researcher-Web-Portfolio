<header class="mb-16 border-b border-slate-200 dark:border-slate-700 pb-8 flex flex-col md:flex-row md:justify-between md:items-start gap-6 transition-colors duration-300">
    <div class="flex flex-col space-y-6">
        ...
        "
               ...
               shadow-[4px_4px_0px_black] dark:shadow-[4px_4px_0px_white] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_black] dark:hover:shadow-[6px_6px_0px_white]">{{ $link->label }}
                        </a>
                    @endforeach
                </div>
