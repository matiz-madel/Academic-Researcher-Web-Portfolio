    ...
    public function run(): void
    {
        PublicProfile::updateOrCreate(
            ...
            [
                ...
                'bio' => [
                    'en' => 'Law student at the Universidade Federal do Paraná (UFPR) and administration technician from IFPR. Bridging a background in Information Systems and software development with academic legal research. Core research areas focus on constitutional law, human rights, philosophy of law, and public policies, accompanied by a strong interest in epistemology and ethics. Passionate about cooking in free time.',
                    'es' => 'Estudiante de Derecho en la Universidade Federal do Paraná (UFPR) y técnica en administración por el IFPR. Con formación previa en Sistemas de Información y experiencia en el desarrollo de software, integra conocimientos tecnológicos con la investigación académica jurídica. Las líneas de investigación se centran en el derecho constitucional, los derechos humanos, la filosofía del derecho y las políticas públicas, con un profundo interés en la epistemología, y la ética. En el tiempo libre, aficionada a la cocina.',
                    'fr' => "Étudiante en droit à l'Universidade Federal do Paraná (UFPR) et technicienne en administration diplômée de l'IFPR. Dotée d'une formation en systèmes d'information et d'une expérience en développement de logiciels, cette expertise technique vient enrichir un parcours académique juridique. Les recherches se concentrent sur le droit constitutionnel, les droits humains, la philosophie du droit et les politiques publiques, avec un intérêt marqué pour l'épistémologie, l'éthique et l'accès à l'information. Pendant le temps libre, passionnée de cuisine.",
                    'pt' => 'Estudante de Direito na Universidade Federal do Paraná (UFPR) e técnica em administração pelo Instituto Federal do Paraná (IFPR). Com formação prévia em Sistemas de Informação e experiência em desenvolvimento de software, busca aliar o conhecimento tecnológico à pesquisa acadêmica jurídica. As áreas de pesquisa e atuação concentram-se em direito constitucional, direitos humanos, filosofia do direito e políticas públicas, com profundo interesse no estudo de epistemologia, e ética. Nas horas vagas, gosta de cozinhar.',
                ],
                'default_message' => [
